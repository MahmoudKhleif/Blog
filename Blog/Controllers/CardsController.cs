...
namespace Blog.Controllers
{
    public class CardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Story,DateTime,Image")] Card card)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Story,DateTime,Image")] Card card)
        {
            if (id != card.Id)
            {
                return NotFound();
